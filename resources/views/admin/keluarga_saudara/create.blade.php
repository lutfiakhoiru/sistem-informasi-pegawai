...
<form action="{{ route('admin.keluarga_saudara.store') }}" method="POST">
    <div class=" mx-auto pb-4">
        <p class="text-2xl font-bold leading-7 text-gray-900  pt-1 pb-4 text-center  "> Tambah Keterangan Saudara</p>
    
        <form action="{{ route('admin.keluarga_saudara.store') }}" method="POST" class="space-y-4">
            @csrf
