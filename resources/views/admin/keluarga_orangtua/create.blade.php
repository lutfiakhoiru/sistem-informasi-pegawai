...
<form action="{{ route('admin.keluarga_orangtua.store') }}" method="POST">
    <div class="mx-auto pb-4">
        <p class="text-2xl font-bold leading-7 text-gray-900  pt-1 pb-5 text-center  "> Tambah Keterangan Orang Tua</p>
    
        <form action="{{ route('admin.keluarga_orangtua.store') }}" method="POST" class="space-y-4">
            @csrf
