...
<div class=" pt-1">
    <form action="{{ route('admin.keluarga_orangtua.update', $orangtua->id_orangtua) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div class="flex justify-between my-5">
            <a href="{{ route('admin.keluarga.index', $orangtua->NIP) }}" class="bg-gray-500 text-white font-bold py-2 px-4 rounded no-underline">Batal</a>
