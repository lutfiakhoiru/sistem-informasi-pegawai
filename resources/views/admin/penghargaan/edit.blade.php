...
<div class="mx-auto"> 
    <form action="{{ route('admin.penghargaan.update', $penghargaan->id_penghargaan) }}" method="POST">
        @csrf
        @method('PUT')
        <p class=" text-2xl font-bold leading-7 text-gray-900 pt-2 pb-3 text-center"> Edit Tanda Jasa/Penghargaan</p>
        <div class="pb-10" >
        ...
        <div class="flex justify-between mt-5">
            <a href="{{ route('admin.penghargaan.index', $penghargaan->NIP) }}" class="bg-gray-500 text-white font-bold py-2 px-4 rounded no-underline">Batal</a>
