...
@section('konten')
     ...
     <div class=" mx-auto ">
        <p class=" text-2xl font-bold leading-7 text-gray-900 pt-2 pb-3 text-center "> Tambah Riwayat Pendidikan</p>
    
        <form action="{{ route('admin.pendidikan.store') }}" method="POST" class="space-y-4">
            @csrf
