...
<div>
    <form action="">
        <div class="flex justify-between ">
            <a href="{{ route('admin.dataPegawai') }}" type="submit" class=" bg-blue-500 text-white font-bold py-2 px-3 rounded no-underline">Kembali</a>
            <a href="{{ route('admin.biodata.edit',$data->NIP) }}" type="submit" class="bg-blue-500 text-white font-bold py-2 px-4 rounded no-underline">Edit</a>
        </div>
        <p class="text-2xl font-bold leading-7 text-gray-900 py-2 text-center">Profil Pegawai</p>
