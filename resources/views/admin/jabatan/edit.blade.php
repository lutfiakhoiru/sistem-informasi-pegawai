...
<div class=" pb-5">
    <form action="{{ route('admin.jabatan.update', $jabatan->id_pekerjaan) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div class="flex justify-between mt-5 ">
            <a href="{{ route('admin.kepangkatan.index', $jabatan->NIP) }}" class="bg-gray-400 text-white font-bold py-2 px-4 rounded no-underline">Batal</a>
