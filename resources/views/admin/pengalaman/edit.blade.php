...
<div class="ml-10 mr-10 pt-1">
    <form action="{{ route('admin.pengalaman.update', $pengalaman->id_pengalaman) }}" method="POST">
        @csrf
        @method('PUT')
        <p class="text-2xl font-bold leading-7 text-gray-900 pt-2 pb-3 text-center ">Edit Pengalaman ke Luar Negeri</p>
        <div class="pb-10">
        ...
        <div class="flex justify-between mt-5">
            <a href="{{ route('admin.pengalaman.index', $pengalaman->NIP) }}" class="bg-gray-500 text-white font-bold py-2 px-4 rounded no-underline">Batal</a>
