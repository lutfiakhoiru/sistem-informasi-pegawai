...
<div class="">
    <form action="{{ route('admin.keluarga.update', $pasangan->id_pasangan) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div class="flex justify-between my-5">
            <a href="{{ route('admin.keluarga.index', $pasangan->NIP) }}" class="bg-gray-500 text-white font-bold py-2 px-4 rounded no-underline">Batal</a>
