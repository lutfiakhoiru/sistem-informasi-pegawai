...
<form action="{{ route('admin.kepangkatan.store') }}" method="POST">
    <div class="  ">
        ...
        <form action="{{ route('admin.kepangkatan.store') }}" method="POST" class="space-y-4">
            @csrf
            ...
            <div class="flex justify-between mt-5">
                <a href="{{ route('admin.kepangkatan.index',$NIP) }}" class="bg-gray-500 text-white font-bold py-2 px-4 rounded no-underline">Batal</a>
