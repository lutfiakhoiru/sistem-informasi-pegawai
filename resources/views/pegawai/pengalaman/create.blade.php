...
<form action="{{ route('pegawai.pengalaman.store') }}" method="POST">
    <div class=" mx-auto">
        <p class="text-2xl font-bold leading-7 text-gray-900 pt-2 pb-4 text-center ">Tambah Pengalaman ke Luar Negeri</p>
