...
<div class="">
    ...
    @method('PUT')
      ...
      <div class="flex justify-between pb-4">
            <a href="{{ route('pegawai.biodata.index') }}" type="submit" class="bg-gray-500 text-white font-bold py-2 px-4 rounded no-underline">Kembali</a>
      ...
      <div class=" pb-10">
        <div class="mt-1 grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-6">
          ...
          <div class="sm:col-span-6 mt-3"></div>
