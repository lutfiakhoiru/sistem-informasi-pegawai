...
<form action="{{ route('pegawai.keluarga.store') }}" method="POST">
    <div class="mx-auto pb-4">
        <p class="text-2xl font-bold leading-7 text-gray-900  pt-1 pb-3 text-center "> Tambah Keterangan Istri/Suami</p>
    
        <form action="{{ route('pegawai.keluarga.store') }}" method="POST" class="space-y-4">
            @csrf
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <div class="mt-1">
                        <input type="date" name="tanggal_nikah" id="tanggal_nikah" autocomplete="off" class="block w-full rounded-md border-0 py-1 px-2 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                    </div>
                </div>
