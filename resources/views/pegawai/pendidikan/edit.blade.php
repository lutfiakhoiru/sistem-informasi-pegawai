...
<div class="ml-10 mr-10 ">
    <form action="{{ route('pegawai.pendidikan.update', $pendidikan->id_pendidikan) }}" method="POST">
        @csrf
        @method('PUT')
        <p class="text-2xl font-bold leading-7 text-gray-900  pb-3 text-center "> Edit Riwayat Pendidikan</p>
        <div class="mb-5">
