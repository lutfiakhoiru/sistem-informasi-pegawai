...
<body>
    ...
    <div class="container">
        <nav class="sidebar d-flex flex-column justify-content-between" id="sidebar">
            <a href="{{ route('pegawai.biodata.index') }}"><i class="fas fa-user me-1"></i>data Pegawai</a>
            <div class="py-4">
                <a href="#" class="logout-link"
                onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i class="fas fa-sign-out-alt me-2"></i> 
                Logout
                </a>
