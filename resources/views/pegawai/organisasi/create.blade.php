...
<form action="{{ route('pegawai.organisasi.store') }}" method="POST">
    <div class=" mx-auto pb-4">
        <p class="text-2xl font-bold leading-7 text-gray-900  pt-1 pb-4 text-center  ">Tambah Pengalaman Organisasi</p>
        <form action="{{ route('pegawai.pengalaman.store') }}" method="POST" class="space-y-4">
            @csrf
            ...
            <div class="flex justify-between my-5">
                <a href="{{ route('pegawai.organisasi.index') }}" class="bg-gray-500 text-white font-bold py-2 px-4 rounded no-underline">Batal</a>
